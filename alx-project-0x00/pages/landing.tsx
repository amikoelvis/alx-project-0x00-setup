    ...
    return (
        <div>
            ...
            <div className="mt-6 space-x-3">
                ...
                <Button title="Small Full" styles="text-sm rounded-full rounded-lg" />
            </div>
            ...
            <div className="mt-4 space-x-3">
                ...
                <Button title="Medium Full" styles="text-base rounded-full rounded-lg" />
            </div>
            ...
            <div className="mt-4 space-x-3">
                ...
                <Button title="Large Full" styles="text-lg px-6 py-3 rounded-full rounded-lg" />
            </div>
        </div>
    )
}
